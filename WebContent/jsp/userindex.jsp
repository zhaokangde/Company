...
<!-- Slider -->
   ...
   <!-- banner图 -->
	<div class="content" >
			<div>
				<img src="<%=path %>/img/index.jpg">
			</div>
		<div>
<div class="page-header">
<br>
<br>
  <h1 style="margin-left: 20px">梦想指引方向. <small>行动创造未来</small></h1>
</div>
<br>
...
<div class="col-sm-4 col-md-4">
    <div class="thumbnail">
      ...
      <div class="caption">
        <h3>合作客户</h3>
        <p style="text-indent:2em;"> 我们秉承把客户摆在优先位置，同客户一在云贵川渝地区指引科技服务逾壹万家客户。</p>
  ...
  <div class="col-sm-4 col-md-4">
    <div class="thumbnail">
      ...
      <div class="caption">
        <h3>资格荣誉</h3>
        <p style="text-indent:2em;">  十几年间，筚路蓝缕，栉风沐雨，指引科技在重团队户能够得到标准、专业、优质的互联网应用服务。高山仰止，不断攀登， “双高企业”、“政府重点扶持企业”以及多套软件专利等资质荣誉会让我们更加明白自己的历史使命和社会责任。</p>
  ...
  <div class="col-sm-4 col-md-4">
    <div class="thumbnail">
      ...
      <div class="caption">
        <h3>企业文化</h3>
          <p style="text-indent:2em;"> 如果需要让巨幕组件的度一致并且没有圆角，请把此组件放在所有如果需..</p>
      </div>
    </div>
  </div>
</div>
